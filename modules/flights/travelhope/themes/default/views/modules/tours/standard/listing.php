                    ...
                    <div class="col-inner d-flex flex-column">
                      ...
                      <div class="content-bottom mt-auto">
                        <div class="d-flex align-items-center">
                          <div>
                            <p><i class="far"></i><?php echo trans('0222');?>: <?php echo character_limiter($item->tourType,5); ?> <strong><?php echo trans('0275');?>: <?php echo $item->tourDays;?>  <?php echo trans('0276');?>: <?php echo $item->tourNights;?></strong></p>
                          </div>
                          <div class="ml-auto">
