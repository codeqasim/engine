    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="api_environment">API Address</label>
                    <input class="form-control" id="api_endpoint" name="" readonly value="<?=json_decode(file_get_contents('http://bookingengine.co/getIpAddress'))->data; ?>"/>
                </div>
            </div>
