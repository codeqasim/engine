...
<div class="progress" style="height:100vh !important">
  <div class="progress-bar progress-bar-striped active" id="progress" style="min-width:10%">
...
<div class="panel panel-default">
  ...
  <p>Congratulations PHPTRAVELS <?php include "../application/config/constants.php"; echo "".PT_VERSION; ?> installed successfully and ready to get started.</p>
  <hr>
   <div class="block">
