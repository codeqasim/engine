...
class FlightTarcoBack extends MX_Controller
{
    ...
    public function bookings()
    {
        ...
        $xcrud->table('pt_tarco_invoice');
        $xcrud->columns('price,status,origincity,destinationcity,origincode,destinationcode,pnrcode');
       // $xcrud->order_by('id', 'desc');
        ...
        $this->data['table_name'] = 'pt_tarco_invoice';
