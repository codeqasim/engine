          ...
          <ol class="fs-fields">
            <li>
              <p class="fs-field-label fs-anim-upper">
                Welcome to
                <strong>PHPTRAVELS <?php include "../application/config/constants.php"; echo "".PT_VERSION; ?></strong> installation! Just fill in the information of this process and get started.
              </p>
            </li>
            <li>
