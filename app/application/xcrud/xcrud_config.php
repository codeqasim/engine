...
class Xcrud_config
{
    ...
    // editor
    public static $editor_url = 'assets/lib/ckeditor/ckeditor.js';
    ...
    public static $xss_naughty_scripts = 'alert|cmd|passthru|eval|exec|expression|system|fopen|fsockopen|file|file_get_contents|readfile|unlink|shell|c99'; // imilar to above, only instead of looking for tags it looks for PHP and JavaScript commands that are disallowed.  Rather than removing the code, it simply converts the parenthesis to entities rendering the code un-executable.
...
//
Xcrud_config::$dbname = Config::$name;
Xcrud_config::$dbuser = Config::$username;
Xcrud_config::$dbhost = Config::$hostname;
