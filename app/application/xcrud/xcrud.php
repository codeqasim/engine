...
//            if (get_magic_quotes_gpc())
    ...
    protected function add_button($class = '', $icon = '')
    {
        ...
        {
            $ab =  "<button style='padding: 2px 14px; margin-left: 10px;' class='btn btn-danger' id='deleteAll'><i class='icon mdi mdi-delete' style='font-size:24px'></i></button> ".$this->render_button('add', 'create', '', $class, $icon) ;
            return $ab;
        }
    }
